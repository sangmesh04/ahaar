...
?>
    <header>
        ...
        <div class="logout">
        <a href="logout.php?logout_id=<?php echo $row['unique_id']; ?>" class="logout"><button>Logout</button></a>
        </div>
    </header>
    <div class="greet">
    ...
    <div class="main">
        <h1>
            YOUR DONATION IS RESPONSIBLE FOR JOY AND SMILE OF NEEDY..!
        </h1>
        <h3>We assure your are donating not only food as well as joy to people!</h3>
        <h3>Beasuse, your food makes them to be joyyed.</h3>
    </div>
<div class="pay">
    Want to help by donating money..?  <br>
    <a href="#"><button>DONATE</button></a>
</div>
<div class="number">
    <h1>Total number of needy people in your area <b><?php echo $row1['']; ?></b></h1>
</div>

    <div class="people">
        <table id="t01">
            <tr>
                <th colspan="6" style="font-size: 30px;background-color: rgb(255, 255, 255);color: rgb(255, 37, 37);">Distributing People in your area</th>
            </tr>
        ...
        <script>
        distriList = document.getElementById("distriList");
                setInterval(() =>{
        let xhr = new XMLHttpRequest();
        xhr.open("GET", "distripeople.php", true);
        xhr.onload = ()=>{
        if(xhr.readyState === XMLHttpRequest.DONE){
        if(xhr.status === 200){
          let data = xhr.response;
          distriList.innerHTML = data;
